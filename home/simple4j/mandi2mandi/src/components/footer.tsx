      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="mb-8 lg:mb-0">
          <div className="lg:hidden">
            ...
            <address className="text-muted-foreground text-sm mb-6 not-italic">
              <strong className="font-semibold text-card-foreground">RKR MANTITOMANDI PRIVATE LIMITED</strong><br/>
        ...
        <div className="border-t border-border mt-8 pt-6 text-center text-sm text-muted-foreground">
          <p>&copy; 2025 RKR MANTITOMANDI PRIVATE LIMITED. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
