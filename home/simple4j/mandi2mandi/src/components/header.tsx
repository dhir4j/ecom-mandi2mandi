          ...
          <SheetContent side="right" className="w-[300px] sm:w-[350px] p-0 flex flex-col">
            ...
            <div className="flex-grow p-4">
              <nav className="flex flex-col gap-4">
                <SheetClose asChild>
                  <Link href="/admin/dashboard" className="text-lg font-medium text-muted-foreground hover:text-foreground flex items-center gap-2">
                    <Shield size={16} /> Admin Panel
                  </Link>
                </SheetClose>
              </nav>
        ...
        {isAdmin ? renderAdminView() : (
          <>
            ...
            <nav className="hidden md:flex items-center gap-2">
              ...
              {navLinks.filter(l => l.label !== 'Categories' && l.label !== 'All Products').map((link) => (
