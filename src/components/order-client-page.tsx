...
import { ArrowLeft, IndianRupee, ChevronsRight } from 'lucide-react';
...
export function OrderClientPage({ product }: { product: Product }) {
  ...
  const handleProceedToCheckout = () => {
    ...
    const query = new URLSearchParams({
      ...
      amountToPay: String(totalPrice.toFixed(2)), // Always 100% advance
        ...
        <Card className="overflow-hidden shadow-lg">
          <div className="grid md:grid-cols-2">
            <div className="relative min-h-[300px] md:h-full">
              <Image src={product.images[0]} alt={product.name} fill style={{objectFit: "cover"}} data-ai-hint={product.aiHint} unoptimized />
            </div>
            <div className="p-8 flex flex-col">
              <CardHeader className="p-0 mb-6">
                <CardTitle className="text-3xl font-headline">{product.name}</CardTitle>
                <CardDescription>Price: ₹{product.price.toFixed(2)} / kg</CardDescription>
              </CardHeader>
                    ...
                    <div className="space-y-4">
                         <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="space-y-2">
                                ...
                                <Input id="buyerName" value={buyerName} onChange={(e) => setBuyerName(e.target.value)} placeholder="Your full name" />
                            </div>
                            <div className="space-y-2">
                         ...
                         <div className="space-y-2">
                            ...
                            <Input id="addressLine1" value={addressLine1} onChange={(e) => setAddressLine1(e.target.value)} placeholder="House No., Building, Street" />
                        </div>
                         <div className="space-y-2">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <Input id="state" value={state} onChange={(e) => setState(e.target.value)} placeholder="e.g., Maharashtra" />
                            </div>
                            <div className="space-y-2">
