...
type UserRole = 'trader' | 'buyer' | 'admin';
...
type User = {
  ...
  email: string;
  role: UserRole;
  hasSubscription?: boolean; // Premium subscription for contact details
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const login = async (credentials: {email: string, password: string}) => {
    try {
      ...
      if (response.ok) {
        setUser(data.user);
        // ✅ Now returning user in the response
